...
import com.caopan.TrainSys.constant.VideoConver;
...
public class ConverVideoUtils {
    ...
    private String videofolder = VideoConver.videofolder; 		// 别的格式视频的目录
    private String targetfolder = VideoConver.targetfolder; 	// flv视频的目录
    private String ffmpegpath = VideoConver.ffmpegpath;		 // ffmpeg.exe的目录
    private String mencoderpath = VideoConver.mencoderpath; 	// mencoder的目录
    private String imageRealPath = VideoConver.imageRealPath;   // 截图的存放目录
