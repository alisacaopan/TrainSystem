...
public class ConverVideoUtils {
    ...
    private String videofolder = FilePath.VIDEO_FOLDER;        // 别的格式视频的目录
    private String targetfolder = FilePath.TARGET_FOLDER;    // flv视频的目录
    private String ffmpegpath = FilePath.FFMPEG_PATH;         // ffmpeg.exe的目录
    private String mencoderpath = FilePath.MENCODER_PATH;    // mencoder的目录
    private String imageRealPath = FilePath.IMAGE_REALPATH;   // 截图的存放目录
