...
//		   String ffmpeg_path,String input_path,String video_converted_path,String logo,String screen_size,String xaxis,String yaxis,String vb,String ab
    ...
    /*public static void  main(String [] arg){
        ...
        dto.put("ffmpeg_path", "C:\\Users\\Administrator\\Desktop\\ffmpeg-20180714-c5329d6-win64-static\\ffmpeg-20180714-c5329d6-win64-static\\bin\\ffmpeg.exe");//必填
        dto.put("input_path", "C:\\Users\\Administrator\\Desktop\\input\\gg.mp4");//必填
        dto.put("video_converted_path", "C:\\Users\\Administrator\\Desktop\\output\\gg2.mp4");//必填
        dto.put("logo", "C\\\\:/Users/Administrator/Desktop/image/timg2.png");//可选(注意windows下面的logo地址前面要写4个反斜杠,如果用浏览器里面调用servlet并传参只用两个,如 d:\\:/ffmpeg/input/logo.png)
