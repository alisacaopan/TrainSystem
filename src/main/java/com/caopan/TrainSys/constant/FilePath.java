...
public class FilePath {
    ...
    public static final String MARK_IMAGE ="E\\\\:/TrainSystem/src/main/resources/static/logo/logo.png"; // 水印的存放目录
    ...
    public static final String IMAGE_REALPATH = "finshvideo"; // 截图的存放目录
